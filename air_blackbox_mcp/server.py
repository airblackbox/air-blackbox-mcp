...
mcp = FastMCP(
    "air-blackbox",
    instructions="EU AI Act compliance scanner — scan, analyze, remediate, and protect AI agent code. 10 tools across scanning, analysis, remediation, and documentation.",
)
...
async def generate_compliance_report(code: str) -> str:
    ...
    lines.append(f"\n**Generated by**: AIR Blackbox MCP v0.1.0")
